...
# into log file named as Log.txt. Log.txt file should be created into current 
# directory. Display execution time required for the script.

# Usage: Directory Duplicate Removal.py "Demo"
...
def main():
    ...
    if(len(sys.argv) == 2):
        if ((sys.argv[1] == "--h") or (sys.argv[1] == "--H")):
            ...
            print("Execution time required :", end - start)
    else:
