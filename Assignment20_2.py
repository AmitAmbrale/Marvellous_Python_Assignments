...
# files from that directory into log file named as Log.txt. Log.txt file should be 
...
def createLogFile(Data):
    ...
    fobj.write("\nTotal number duplicate files :" + str(len(Data)))
    fobj.write("\nDuplicate Files :\n")
...
def main():
    ...
    if(len(sys.argv) == 2):
        if ((sys.argv[1] == "--h") or (sys.argv[1] == "--H")):
            print("This application is used to write names of duplicate files from given directory into log file named as Log.txt")    
