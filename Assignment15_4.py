# Write a program which accept two file names from user
# and compare contents of both the files. If both the 
# files contains same contents then display success 
# otherwise display failure. Accept names of both the 
